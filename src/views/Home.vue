<template>
	<div>
		<header
			v-bind:class="{ 'header-fixed': navFixed }"
			v-on:wheel="headerScroll"
		>
			<div class="title">
				<h1>osu.sh</h1>
				<div class="down">
					...
					<div class="right">
						<h2>
							osu!
							<router-link class="package-link" to="/package"
								># 镜像站</router-link
							>
						</h2>
						<div class="progress">
			...
			<div ref="nav" class="nav">
				...
				<search-bar
					ref="searchBar"
					v-bind:searchOptine="searchOptine"
				></search-bar>
				...
				<div class="scroll-content">
					...
					<div class="pullup-wrapper">
						<div v-if="!isPullUpLoad" class="before-trigger">
							<span class="pullup-txt" @click="pullingUpHandler"
								>加载更多</span
							>
						</div>
